...
- Presentation file, P.13
  - The Linux Foundation, check the training [edX - Introduction to Linux](https://www.edx.org/course/introduction-to-linux) (It's a free online training) get more details about System Structure. `Course / Chapter 3: Linux Basics and System Startup / Linux Filesystem Basics / The Filesystem Hierarchy Standard` 
